        ...
        <%@ page import = "com.student.entity.*, com.student.service.*" %>
            ...
            %>
                    ...
                    <head>
                        ...
                        <title>End Sem Marks - Teacher Dashboard</title>
                    ...
                    <body>
                        ...
                        <div class="main-wrapper">
                            <header class="top-navbar">
                                <div class="top-left">
                                    ...
                                    <h1 class="page-title">End Sem Marks</h1>
                                </div>
                            ...
                            <main class="content-area">
                                <div class="container">
                                    ...
                                    <div class="stats-grid">
                                        ...
                                        <div class="stat-card">
                                            <div class="stat-info">
                                                <h4>Exam Weightage</h4>
                                                <div>50 Max Marks</div>
                                            </div>
                                            <div class="stat-icon-wrap">
                                                <svg width="22" height="22" viewBox="0 0 24 24" fill="none"
                                                    stroke="currentColor" stroke-width="2">
                                    ...
                                    <!-- End Sem Marks Entry Card -->
                                    <form action="${pageContext.request.contextPath}/teacher/save-end-sem-marks"
                                        method="post">
                                            ...
                                            <div class="card-header-row">
                                                <div>
                                                    <h3>
                                                        ...
                                                        End Semester Theory Marks Form
                                                    </h3>
                                                    <p
                                                        style="font-size: 0.8rem; color: var(--text-muted); margin-top: 0.25rem;">
                                                        Select Subject & enter End Sem Theory Examination Marks out
                                                        of
                                                        50 per student.
                                                    </p>
                                                </div>
                                                <div
                                                    ...
                                                    <select class="subject-selector" id="subjectSelector"
                                                        name="subjectId"
                                                        onchange="location.href='end-sem-marks.jsp?subjectId=' + this.value;">
                                                        <%
                                                            if (teacherAssignedSubjects != null && !teacherAssignedSubjects.isEmpty())
                                                            {
                                                        %>
                                                ...
                                                <table class="data-table">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th style="text-align: center;">End Sem Theory Marks
                                                                (/50)</th>
                                                            ...
                                                            <% int stIdx = 1; %>
                                                                <%
                                                                    for (StudentSubjectAssignment ssa : assignedStudents)
                                                                    {
                                                                        ...
                                                                        int endSemVal = (mark != null) ? (int)mark.getEndSemesterMarks() : 0;
                                                                        String status = (endSemVal>= 20) ? "Pass" : "Fail";
                                                                ...
                                                                %>
                                                                    <tr data-year="<%= studentYear %>"
                                                                        ...
                                                                        <td style="text-align: center;">
                                                                            <div class="inline-marks-wrap">
                                                                                <input type="number"
                                                                                    name="end_sem_<%= student.getId() %>"
                                                                                    class="input-marks-single"
                                                                                    value="<%= endSemVal %>" max="50"
                                                                                    min="0"
                                                                                    title="End Sem Theory Marks (max 50)">
                                                                                <span>/ 50</span>
                                                                            </div>
                                                                        </td>
                                                                        <td style="text-align: center;">
                        ...
                        <script>
                            ...
                            document.addEventListener('DOMContentLoaded', () => {
                                ...
                                const rows = document.querySelectorAll('.data-table tbody tr');
                                rows.forEach(row => {
                                    const input = row.querySelector('.input-marks-single');
                                    if (input) {
                                        input.addEventListener('input', () => recalculateEndSemRow(row));
                                    }
                                });
                    ...
                    `;
                                ...
                                if (saveBtn) {
                                    saveBtn.addEventListener('click', () => {
                                        showToast('End Sem Theory marks saved successfully!', 'success');
                                    });
                                }
                            });
                        </script>
