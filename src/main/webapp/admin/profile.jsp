    ...
    <%
        ...
        if (loggedAdmin != null)
        {
            ...
            if (rawName != null && !rawName.trim().isEmpty())
            {
                ...
                {
                    bannerInitials = String.valueOf(adminName.charAt(0)).toUpperCase();
                }
            }
        }
        String dispName = (loggedAdmin != null && loggedAdmin.getName() != null && !loggedAdmin.getName().trim().isEmpty()) ? loggedAdmin.getName().trim() : "--";
        String dispUsername = (loggedAdmin != null && loggedAdmin.getUsername() != null && !loggedAdmin.getUsername().trim().isEmpty()) ? loggedAdmin.getUsername().trim() : "--";
        String dispEmail = (loggedAdmin != null && loggedAdmin.getEmail() != null && !loggedAdmin.getEmail().trim().isEmpty()) ? loggedAdmin.getEmail().trim() : "--";
        String dispPhone = (loggedAdmin != null && loggedAdmin.getPhone() != null && !loggedAdmin.getPhone().trim().isEmpty()) ? loggedAdmin.getPhone().trim() : "--";
    %>
        <!DOCTYPE html>
        <html lang="en">
                    ...
                    <div class="container">
                        ...
                        <div class="profile-banner-card">
                            <div class="banner-avatar-wrapper">
                                ...
                                <div class="status-dot" title="Account Active"></div>
                            </div>
                            <div class="banner-info">
                                ...
                                <div class="banner-role-tag">
                                    ...
                                    <span>Super Administrator &bull; Full System Access</span>
                                </div>
                            </div>
                        </div>
